...
print("string_value:",string_value, type(string_value)) #<class 'str'>
...
print("int_value 변수에 저장된 데이터타입이 int가 맞아?", isinstance(int_value,int)) #int_value 변수에 저장된 데이터타입이 int가 맞아? True
